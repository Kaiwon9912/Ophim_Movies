...
import { useMovieCountry } from "@/features/movies/hook";
...
const { data, isLoading } = useMovieCountry(slug!, currentPage, limit);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-10 px-6">
      <h1 className="text-3xl font-bold mb-6 capitalize text-start">
        Phim: <span className="text-red-500">{slug?.replace(/-/g, " ")}</span>
      </h1>
